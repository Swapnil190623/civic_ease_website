...
const [currentPage, setCurrentPage] = useState('home');
  ...
  return (
    ...
    <div className="min-h-screen bg-linear-to-br from-emerald-100 via-white to-teal-50">
      {/* Navigation */}
      <nav className="bg-white/80 backdrop-blur-md border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <button onClick={() => setCurrentPage('home')} className="flex items-center space-x-3">
              <div className="w-11 h-11 bg-linear-to-br from-emerald-600 to-teal-500 rounded-xl flex items-center justify-center shadow-lg">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center space-x-2 px-4 py-2 bg-emerald-100 rounded-full mb-6">
            ...
            <span className="text-sm font-semibold text-emerald-700">Takes less than 2 minutes</span>
          </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
          <div className="bg-linear-to-r from-emerald-600 to-teal-400 px-8 py-6">
            <h2 className="text-2xl font-bold text-white">Issue Details</h2>
            <p className="text-emerald-100 mt-1">Fill in the information below</p>
          </div>
          ...
          <form className="p-8 space-y-6">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-900 mb-3">
                Issue Title <span className="text-teal-500">*</span>
              </label>
              <input
                type="text"
                placeholder="e.g., Broken street light on Main Road"
                className="w-full px-5 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition text-gray-900 placeholder-gray-400"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-5 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition resize-none text-gray-900 placeholder-gray-400"
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <select 
                  className="w-full px-5 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition text-gray-900"
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-900 mb-3">
                  Priority Level <span className="text-emerald-500">*</span>
                </label>
                <select 
                  className="w-full px-5 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition text-gray-900"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-5 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition text-gray-900 placeholder-gray-400"
                  value={formData.location}
                  onChange={(e) => setFormData({...formData, location: e.target.value})}
                />
              </div>
              <button type="button" className="mt-3 text-sm text-emerald-600 font-semibold hover:text-emerald-700 flex items-center space-x-1">
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-2xl p-12 text-center hover:border-emerald-500 hover:bg-emerald-50/50 transition cursor-pointer group">
                <div className="w-16 h-16 bg-emerald-100 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-emerald-200 transition">
            ...
            <div className="flex gap-4 pt-6">
              ...
              <button
                type="submit"
                className="flex-1 px-6 py-4 bg-linear-to-r from-emerald-600 to-teal-500 text-white font-semibold rounded-xl shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40 transition-all duration-300 flex items-center justify-center space-x-2"
              >
