    ...
    <div className="min-h-screen w-full bg-white text-gray-800 font-sans">
      ...
      <header className="fixed top-0 left-0 w-full bg-white/90 backdrop-blur-sm shadow z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex space-x-3">
            <button className="px-5 py-2 bg-emerald-600 text-white text-sm font-medium rounded-full shadow hover:bg-emerald-700 transition">
              Report Issue
            </button>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 flex md:flex-row items-center justify-between gap-10">
          ...
          <div className="text-center md:text-left md:w-1/2 space-y-6">
            ...
            <div className="flex justify-center md:justify-start space-x-4 pt-4">
              <button className="px-6 py-3 bg-emerald-600 text-white font-medium rounded-full shadow hover:bg-emerald-700 transition transform hover:scale-105">
                Report an Issue
              </button>
          ...
          <div className="md:w-1/2 flex justify-center">
            <img
              src="\src\assets\Urban Civic Reporting in Action.png" // Replace with generated image
      ...
      <section className="bg-emerald-50 py-16">
        <div className="max-w-7xl mx-auto px-6 flex md:flex-row justify-center items-center gap-8">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md text-center w-48 hover:scale-105 transition">
            <h3 className="text-4xl font-bold text-emerald-600">200</h3>
